...
<h1 class="title is-2">Random Programming Language Generator</h1>

<p>Language = {lang}</p>

<div id="generate">
    <button on:click={generateNew} class="button is-large is-rounded is-black is-outlined" style="font-family: 'VT323', monospace;">Generate</button>
</div>